...
import { Eye, EyeOff, Lock, Mail, Sparkles, Star, ArrowRight, Shirt, Truck, ShieldCheck } from "lucide-react";
                ...
                <div className="flex items-center justify-center px-4 py-10 sm:px-6 lg:px-10">
                    <div className="w-full max-w-md rounded-[2rem] border border-black/5 bg-white p-6 shadow-sm sm:p-8">
                        ...
                        <p className="mt-6 text-center text-xs text-zinc-400">
                            ...
                            <Link to="/register" className="font-medium text-zinc-700 hover:text-zinc-900">
                                Register
                            </Link>
                        </p>
                    </div>
